...
## Project Structure
    ...
    ├── testapiautosettingssjbh_7  # Django project configurations
...
1. Clone this repo and `cd testapiautosettingssjbh_7`
...
2. Clone this repo and `cd testapiautosettingssjbh_7`
